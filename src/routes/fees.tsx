            ...
            <table className="w-full text-sm border-collapse">
              <thead className="sticky top-0 z-40 bg-blue-600 dark:bg-blue-700 text-white border-b shadow-xs">
                <tr className="text-left text-xs uppercase tracking-widest bg-blue-600 dark:bg-blue-700 text-white">
                  ...
                  <th className="px-4 py-3.5 font-semibold min-w-36 whitespace-nowrap bg-blue-600 dark:bg-blue-700 text-white">Course</th>
                  ...
                  <th className="px-4 py-3.5 text-right font-semibold min-w-40 whitespace-nowrap bg-blue-600 dark:bg-blue-700 text-white">Total Payable Fees</th>
                  <th className="px-4 py-3.5 text-right font-semibold min-w-32 whitespace-nowrap bg-blue-600 dark:bg-blue-700 text-white">Late Fees</th>
                  <th className="px-4 py-3.5 text-right font-semibold min-w-28 whitespace-nowrap bg-blue-600 dark:bg-blue-700 text-white">Fine</th>
                  <th className="px-4 py-3.5 text-right font-semibold min-w-28 whitespace-nowrap bg-blue-600 dark:bg-blue-700 text-white">Other</th>
                  <th className="px-4 py-3.5 text-right font-semibold min-w-32 whitespace-nowrap bg-blue-600 dark:bg-blue-700 text-white">Concession</th>
                  <th className="px-4 py-3.5 text-right font-semibold min-w-32 whitespace-nowrap bg-blue-600 dark:bg-blue-700 text-white">Scholarship</th>
                  <th className="px-4 py-3.5 text-right font-semibold min-w-44 whitespace-nowrap bg-blue-600 dark:bg-blue-700 text-white">Amount Net Payable</th>
                  <th className="px-4 py-3.5 text-right font-semibold min-w-36 whitespace-nowrap bg-blue-600 dark:bg-blue-700 text-white">Amount Paid</th>
                  <th className="px-4 py-3.5 text-right font-semibold min-w-32 whitespace-nowrap bg-blue-600 dark:bg-blue-700 text-white">Balance</th>
                  <th className="px-4 py-3.5 text-right font-semibold min-w-44 whitespace-nowrap bg-blue-600 dark:bg-blue-700 text-white">Amount Paid Date</th>
                  <th className="px-4 py-3.5 text-left font-semibold min-w-48 whitespace-nowrap bg-blue-600 dark:bg-blue-700 text-white">Remarks</th>
                  <th className="px-4 py-3.5 min-w-48 text-right whitespace-nowrap bg-blue-600 dark:bg-blue-700 text-white">Actions</th>
                </tr>
              </thead>
